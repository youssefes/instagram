...
class MainTabBarController: UITabBarController {
    ...
    func setupViewController()  {
        ...
        let Home = templateNavigationController(unSelectedImage: UnselectImageHome, selectedImage: imageSelectedHome, rootViewController: UserProfileVC(collectionViewLayout: UICollectionViewFlowLayout()))
